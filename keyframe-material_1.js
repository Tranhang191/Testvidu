...
{
	var geometry = new THREE.SphereGeometry(1, 32, 32); // tạo hình tròn 
	this.ballmaterial = new THREE.MeshPhongMaterial(
		{
			color : 0xff0000, ambient : 0x222222,
	   transparent : true
   		});
	...
	this.cubematerial = new THREE.MeshPhongMaterial({ color : 0x0055ff });// tạo hình vuông
	...
	geometry = new THREE.CylinderGeometry(1, 1, 2, 32);// tạo hình trụ
	this.cylindermaterial = new THREE.MeshPhongMaterial(
		{
			 color : 0xcccccc, shininess : 1,
		specular : 0xffff00 
	});
