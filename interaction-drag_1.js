...
// Subclass Sim.App
InteractionApp.prototype = new Sim.App(this);
...
InteractionApp.prototype.init = function(param)
{
	...
	var light = new THREE.DirectionalLight( 0xd8d0d1, 1);
...
Model.prototype.init = function(param)
{
	...
	var material = new THREE.MeshPhongMaterial(
		{
			color: 0xf25346, wireframe : false
		}
	);
...
{
	this.mesh.material.ambient.setRGB(geometry,material);
}
