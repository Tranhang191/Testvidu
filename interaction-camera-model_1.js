...
ModelViewer.prototype.init = function(param)
{
	...
	this.camera.position.set(-10, 0, 8);
...
ModelViewer.CAMERA_START_Z = 1;
ModelViewer.CAMERA_RADIUS = 0;
ModelViewer.MIN_DISTANCE_FACTOR = 1;
ModelViewer.MAX_DISTANCE_FACTOR = 1;
ModelViewer.ROTATE_SPEED = 1;
ModelViewer.ZOOM_SPEED = 1;
ModelViewer.PAN_SPEED = 1;
ModelViewer.DAMPING_FACTOR = 1;
